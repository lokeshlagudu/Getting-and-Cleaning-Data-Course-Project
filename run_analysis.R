#Reading the column Indexes
column_names<-read.table("C:/Users/Lokesh/SkyDrive/Documents/features.txt")
...
activity_labels<-read.table("C:/Users/Lokesh/SkyDrive/Documents/activity_labels.txt")

#Reading the training and testing subject files
subject_test<-read.table("C:/Users/Lokesh/SkyDrive/Documents/test/subject_test.txt")
subject_train<-read.table("C:/Users/Lokesh/SkyDrive/Documents/train/subject_train.txt")
...
x_test<-read.table("C:/Users/Lokesh/SkyDrive/Documents/test/X_test.txt")
x_train<-read.table("C:/Users/Lokesh/SkyDrive/Documents/train/X_train.txt")
...
y_test<-read.table("C:/Users/Lokesh/SkyDrive/Documents/test/y_test.txt")
y_train<-read.table("C:/Users/Lokesh/SkyDrive/Documents/train/y_train.txt")
...
write.table(dataset,file="dataset1.txt",row.name=FALSE)
